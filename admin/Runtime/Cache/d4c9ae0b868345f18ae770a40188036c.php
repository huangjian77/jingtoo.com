        ...
        <div class="span2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">  
              ...
              <li class="active"><a href="__URL__/contentManage">栏目管理</a></li>
              <li><a href="__URL__/docManage">文章管理</a></li>                    
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
        <div class="span10">
		<div>
		  <div align="right"><a href="__URL__/addContent">新增</a></div>
		  <table class="table">
		  ...
		  <tbody>
		    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><tr class="info"><?php endif; ?>
		     <?php if(($mod) == "1"): ?><tr class="sucess"><?php endif; ?>
		      <td><?php echo ($vo["display_order"]); ?></td>
		      <td><?php echo ($vo["name"]); ?></td>
		      <td><?php echo ($vo["url"]); ?></td>
		      <td>
		        <?php if(($vo["content_type"] == 0)): ?>文章列表
		        <?php elseif(($vo["content_type"] == 1)): ?>指定文章
		        <?php elseif(($vo["content_type"] == 2)): ?>内部链接
		        <?php elseif(($vo["content_type"] == 3)): ?>外部连接<?php endif; ?>       
		      </td>
		      <td>
		        <?php if(($vo["is_show"] == 0)): ?>不显示
		        <?php elseif(($vo["is_show"] == 1)): ?>显示<?php endif; ?> 
		      </td>
		      <td><?php echo ($vo["description"]); ?></td>
		      <td>
		        <a href="__URL__/editContent/contId/<?php echo ($vo["id"]); ?>">修改</a>
		        <a href="__URL__/doDelContent/contId/<?php echo ($vo["id"]); ?>">删除</a>
		      </td>
